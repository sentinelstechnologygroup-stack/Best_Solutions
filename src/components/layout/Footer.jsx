    ...
    <footer className="bg-primary text-white">
      ...
      <div className="bg-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-display font-bold text-white text-lg text-center sm:text-left">
            Ready to Start Your Project? Get a Free Estimate Today.
          </p>
          <div className="flex gap-3">
            <Link
              to="/contact"
              className="bg-white text-accent font-semibold px-5 py-2.5 rounded text-sm hover:bg-white/90 transition-colors duration-150 whitespace-nowrap"
            >
              Get Free Estimate
            </Link>
            <a
              href={PHONE_HREF}
              className="border border-white/50 text-white font-semibold px-5 py-2.5 rounded text-sm hover:bg-white/10 transition-colors duration-150 whitespace-nowrap"
            >
              Call Now
            </a>
          </div>
